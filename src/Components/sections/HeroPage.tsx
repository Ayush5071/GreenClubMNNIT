...
function HeroPage() {
  return (
    <WavyBackground className="max-w-4xl mx-auto pb-40">
      <p className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white font-bold inter-var text-center">
        GREEN CLUB MNNIT
      </p>
      <p className="text-lg md:text-xl mt-4 text-white font-light inter-var text-center max-w-3xl mx-auto">
