...
export const StickyScroll = ({
  ...
  return (
    <motion.div
      ...
      className="h-[40rem] overflow-y-auto flex justify-center relative space-x-10 rounded-md p-10 scrollbar-none"
      ref={ref}
    >
          ...
          {content.map((item, index) => (
            <div key={item.title + index} className="my-20">
              <motion.h2
                ...
                className="text-3xl md:text-6xl font-bebas font-bold text-slate-100"
              >
                {item.title}
              </motion.h2>
              <motion.p
                ...
                className="text-kg font-Sfpro text-slate-300 max-w-sm mt-10"
              >
                {item.description}
              </motion.p>
            </div>
